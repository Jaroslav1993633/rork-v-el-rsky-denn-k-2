...
export default function HiveDetailScreen() {
  ...
  const [newYieldType, setNewYieldType] = useState<'med' | 'pel' | 'propolis' | 'vosk'>('med');
  ...
  const [editYieldType, setEditYieldType] = useState<'med' | 'pel' | 'propolis' | 'vosk'>('med');
          ...
          {showAddYield && (
            <View style={styles.addForm}>
              <View style={styles.yieldTypeSelector}>
                {(['med', 'pel', 'propolis', 'vosk'] as const).map((type) => (
                  <TouchableOpacity
                    key={type}
                    style={[
                  ...
                  >
                    <Text style={[
                      ...
                      {type === 'med' ? 'Med' : type === 'pel' ? 'Pel' : type === 'propolis' ? 'Propolis' : 'Vosk'}
                    </Text>
                  </TouchableOpacity>
                ))}
              </View>
                ...
                <>
                  <View style={styles.listItemHeader}>
                    <Text style={styles.listItemTitle}>
                      {yieldItem.type === 'med' ? 'Med' : yieldItem.type === 'pel' ? 'Pel' : yieldItem.type === 'propolis' ? 'Propolis' : 'Vosk'}
                    </Text>
